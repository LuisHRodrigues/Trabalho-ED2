...
public class Utilidades {
   ...
   public static Item[] geraDataset(int tamanho) {
       ...
       // Para cada tamanho vai gerar um vetor de 'Item' com o tamanho especificado e armazena esse vetor na matriz 'dataset1'
    ...
    public static Item[][] geraDataset2() {
        ...
        for (int i = 0; i < tamanhos.length; i++) {
            ...
            // Para cada tamanho vai gerar um vetor de 'Item' com o tamanho definido e armazena esse vetor na matriz 'dataset2'
